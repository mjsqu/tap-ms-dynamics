...
class DynamicsBaseTest(unittest.TestCase):
    """
    Setup expectations for test sub classes.
    ...
    def get_credentials():
        ...
        return {"resource": os.getenv('TAP_DYNAMICS_RESOURCE'),
                ...
                "refresh_token": os.getenv('TAP_DYNAMICS_REFRESH_TOKEN')}
    ...
    def setUp(self):
        """Verify that you have set the prerequisites to run the tap (credentials, etc.)"""
        missing_envs = [x for x in ['TAP_DYNAMICS_ORG_URI',
                                    'TAP_DYNAMICS_CLIENT_ID',
                                    'TAP_DYNAMICS_CLIENT_SECRET',
                                    'TAP_DYNAMICS_REDIRECT_URI',
                                    'TAP_DYNAMICS_REFRESH_TOKEN']
